...
KBUILD_CFLAGS	+= $(call cc-option,-march=armv8-a+crc+crypto -mcpu=cortex-a53.cortex-a53+crc+crypto) -mtune=cortex-a53
KBUILD_AFLAGS	+= $(call cc-option,-march=armv8-a+crc+crypto -mcpu=cortex-a53.cortex-a53+crc+crypto) -mtune=cortex-a53
endif
